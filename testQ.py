...
class TestQ (unittest.TestCase):
    ...
    def testExt2Lang(self):
        ...
        self.assertEqual(self.q.ext2Lang('f90'), 'f90+')
        self.assertEqual(self.q.ext2Lang('f95'), 'f90+')
        self.assertEqual(self.q.ext2Lang('f03'), 'f90+')
        self.assertEqual(self.q.ext2Lang('f08'), 'f90+')
        self.assertEqual(self.q.ext2Lang('f15'), 'f90+')
        self.assertEqual(self.q.ext2Lang('for'), 'for')
